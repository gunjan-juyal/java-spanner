...
public class TemplatedCodeTest {
  ...
  public void lineHasAutogeneratedMarkerTest() {
    ...
    Optional<String> chunkId = templatedCode.getChunkIdFromSourceLine("// Start-autogenerated-code #body");
    assertTrue(chunkId.isPresent());
    assertEquals("body", chunkId.get());
    chunkId = templatedCode.getChunkIdFromSourceLine("   //      Start-autogenerated-code    #imports. blah");
    assertTrue(chunkId.isPresent());
