...
// Start-autogenerated-code #privateStaticsCodeToPrimitiveTypeMap
      .put(Code.NUMERIC, TYPE_NUMERIC) // TODO(Auto-generation): Review to verify that the new type can be handled as a primitive type
...
// Start-autogenerated-code #privateStaticsSupportedPrimitiveTypeClasses
          , BigDecimal.class // TODO(Auto-generation): Review to verify that the new type can be handled as a primitive type
...
// Start-autogenerated-code #privateStaticsSupportedPrimitiveTypeCodes
          , Code.NUMERIC // TODO(Auto-generation): Review to verify that the new type can be handled as a primitive type
...
// TODO(Auto-generation): Review to verify that the new type NUMERIC is handled as a primitive type and no special handling is needed here
