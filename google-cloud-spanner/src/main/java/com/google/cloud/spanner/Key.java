...
// Start-autogenerated-code #ifBlockAppendObject
        else if (value instanceof BigDecimal) {
          buffer.add((BigDecimal)value); // TODO(Auto-generation): Review to see if any special handling is needed or if this block is made redundant by the default catch-all condition
        }


// End-autogenerated-code #ifBlockAppendObject
        else {
          buffer.add(value);
        }
      } else {
...
// Start-autogenerated-code #javadocGetParts
   *   <li>{@code NUMERIC} is represented by {@link BigDecimal}


// End-autogenerated-code #javadocGetParts
   * </ul>
   *
...
// Start-autogenerated-code #ifBlockToProto
...
// End-autogenerated-code #ifBlockToProto
      else {
